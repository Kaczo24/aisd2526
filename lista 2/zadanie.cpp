...
int main()
{
    ...
    int sizes[] = { 10, 50, 100, 1000, 10000, 50000, 100000, 500000 };
    for (int size : sizes) {

        float quickTime = 0, quick3Time = 0, bucketTime = 0;
        float* arr1 = new float[size], * arr2 = new float[size], * arr3 = new float[size];
        ...
        for (int t = 0; t < tests; t++) {
            ...
            quickTime += duration_cast<nanoseconds>(t2 - t1).count() / 1000.0;
            quick3Time += duration_cast<nanoseconds>(t3 - t2).count() / 1000.0;
            bucketTime += duration_cast<nanoseconds>(t4 - t3).count() / 1000.0;
        }
